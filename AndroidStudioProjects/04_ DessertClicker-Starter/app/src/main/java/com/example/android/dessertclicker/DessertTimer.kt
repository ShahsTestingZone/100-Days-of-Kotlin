...
class DessertTimer(lifecycle: Lifecycle): LifecycleObserver {
    ...
    fun startTimer() {
        // Create the runnable action, which prints out a log and increments the seconds counter _
        // This is a self created loop - the runnable is variable that uses itself within the code block and re-runs the code
        runnable = Runnable {
            secondsCount++
