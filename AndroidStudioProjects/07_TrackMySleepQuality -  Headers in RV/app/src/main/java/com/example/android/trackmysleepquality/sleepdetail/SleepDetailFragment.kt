...
class SleepDetailFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        // remove bang bang - test we just need to make it compile and haven't added navigation from previous fragment yet.
        // Alternative use requireArguments() instead of arguments.
       // we should use requireArguments instead of arguments
       // because requireArguments are NonNull and arguments are Nullable
