...
// delete below because List Adapter keeps track of this for you.
...
// In the setter, give data a new value, then call notifyDataSetChanged() to trigger redrawing the list with the new data.
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        // changed above signature override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Recycler.ViewHolder { - removed Recycler
//        return RecyclerView.ViewHolder.from(parent)
        return SleepNightAdapter.ViewHolder.Companion.from(parent)
    }

    //the ListAdapter implements this method for you.
...
//        //use below function that List Adapter Provides
//        val item = getItem(position)
//        holder.bind(item)
//
//    }
